...
let g:colors_name = "dracula_black"
...
" hi LineNr ctermfg=60 ctermbg=NONE cterm=NONE guifg=#6272a4 guibg=#0b0b0b gui=NONE
hi LineNr ctermfg=60 ctermbg=NONE cterm=NONE guifg=#ffffff guibg=#0b0b0b gui=NONE
...
hi Pmenu ctermfg=NONE ctermbg=NONE cterm=NONE guifg=#ffffff guibg=#3C3E50 gui=NONE
hi PmenuSel ctermfg=NONE ctermbg=236 cterm=NONE guifg=#ffffff guibg=#64666d  gui=NONE
hi IncSearch ctermfg=17 ctermbg=215 cterm=none guifg=#0b0b0b guibg=#ffb86c gui=none
hi Search ctermfg=17 ctermbg=84 cterm=none guifg=#0b0b0b guibg=#50fa7b gui=none
hi Directory ctermfg=141 ctermbg=NONE cterm=NONE guifg=#bd93f9 guibg=NONE gui=NONE
hi Folded ctermfg=61 ctermbg=235 cterm=NONE guifg=#6272a4 guibg=#0b0b0b gui=NONE
...
hi Normal guifg=#f8f8f2 guibg=#0b0b0b gui=NONE
...
hi TabLineFill  guifg=#333333 guibg=#0b0b0b gui=none
hi TabLine      guifg=#666666 guibg=#0b0b0b gui=none
hi TabLineSel   guifg=WHITE guibg=#0b0b0b gui=none
